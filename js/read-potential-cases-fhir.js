...
(async () => {
  ...
  await fs.writeFile("rheumatological-disease-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("rheumatological-disease-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
